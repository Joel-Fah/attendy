    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('FALL', 'FALL'), ('SPRING', 'SPRING'), ('SUMMER', 'SUMMER')], help_text='Semester of the class level', max_length=255)),
                ('year', models.IntegerField(default=core.models.get_current_year, help_text="Semester's year of the class level")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(default=core.models.get_current_year, help_text="Semester's year of the course")),
                ...
                ('class_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_level_course', to='core.classlevel')),
                ('lecturer', models.ForeignKey(blank=True, help_text='Lecturer teaching the course', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='course_lecturer', to='core.lecturer')),
            ],
            options={
                'verbose_name': 'Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_attendance', to='core.course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Resolved', 'Resolved')], default='Pending', help_text='Status of the feedback: Pending, Resolved', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoded_data', models.TextField(blank=True, editable=False, help_text='Encoded data for the QR code', null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date and time this course registration was last updated')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registration', to='core.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registration', to='core.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='teaching_record', to='core.attendance')),
            ],
            options={
